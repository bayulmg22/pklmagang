<div class="w-full h-full flex flex-col">
    <!-- Brand -->
    <div class="h-24 flex items-center px-6 bg-white/50 border-b border-sky-200 backdrop-blur-sm shrink-0">
    ...
    <!-- Footer -->
    @auth
    <div class="p-4 bg-white/30 border-t border-sky-200 shrink-0">
